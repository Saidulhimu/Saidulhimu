...
* 💻 **Full-Stack Web Developer** with hands-on expertise in **Next.js, React.js, TypeScript, and Node.js**.
* 🤖 Specialized in integrating **Machine Learning & Natural Language Processing (NLP)** models into web apps with **SHAP/LIME** explainability.
* 🏆 **1st Runner Up** at BUBT Brainstorming Week Competition & Active Technical Member of BUBT IT Club.
* 🎯 **Goal:** Building high-performance, scalable web applications with modern architectures and clean code.

---

### 🔭 Current Activities
- 🚀 **Building with Next.js:** Developing full-stack web applications using **Next.js App Router, SSR, and API Routes**.
- 🧪 **Project Lead:** [DharmaSafe](https://github.com/Saidulhimu) — AI-Powered Web Aggression Detection System (91.5% accuracy).
- 🎓 **Skill Enhancement:** Enrolled in **AI-Driven Full Stack Web Engineering** at Programming Hero.
...
<div align="center">
💻 <i>"Building fast, scalable full-stack web applications with modern technology."</i>
</div>
